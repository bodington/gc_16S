...
ggplot2::ggsave(errFplot, file = "02_output/filtF.error.rate.pdf")
errRplot <- plotErrors(errF, nominalQ=TRUE)
ggplot2::ggsave(errRplot, file = "02_output/filtR.error.rate.pdf")
...
write.csv(track, file = "./02_output/sample_tracking.csv")
