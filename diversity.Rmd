...
phylum_levels <- append(levels(factor(tax_table(ps_16S)[,"Phylum"])), "Other")
```
...
taxa_16S_plot$data$Phylum <- factor(taxa_16S_plot$data$Phylum, levels = append(levels(factor(tax_table(ps_16S_proteo)[,"Phylum"])), "Other"))
