...
phyloseq_write_dataset(ps_all, "./01_data/06_tree/", "ps_all")

asv_tree <- read_tree("01_data/06_tree/ps_all_ASVs.tre")
ps_all <- merge_phyloseq(ps_all, asv_tree) %>%
  phyloseq_root_tree()
...
alpha_all$diversity_faith <- phyloseq_phylo_div(ps_all, measures = c("PD"))[,1]
