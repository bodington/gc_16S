...
ps_merge <- phyloseq(otu_merge, sample_data_merge, tax_merge, refseq(ps_raw))
...
ggsave(taxa_plot, file = "./02_out/test_alpha.png", height = 8, width = 16)
```
