...
unifrac_plot <- plot_ordination(ps,
                  ...
                  scale_shape_discrete(name = "Fraction", labels = names(labels_fractioned)) +
                  geom_point(size = 4)
...
relabund_pal <- c(pal_simpsons("springfield")(16)[-5], "steelblue2", pal_flatui("default")(8), "dimgray")
```
...
frac_taxa_plot <- plot_bar(ps_frac,
  ...
  theme() +
  scale_fill_manual(values = relabund_pal) +
